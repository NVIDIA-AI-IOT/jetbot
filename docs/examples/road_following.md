...
6. Upload the road following avoidance [training notebook](https://github.com/NVIDIA-AI-IOT/jetbot/blob/master/notebooks/road_following/train_model.ipynb) to this folder
...
6. Open and follow the ``live_demo_trt.ipynb`` notebook to run the optimized model
