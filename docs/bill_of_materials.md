...
If you are using Jetson Nano 2GB Developer Kit, you can either use the USB Wi-fi dongle that is bundled (depending on the region), or one of the USB wifi dongle listed below.
